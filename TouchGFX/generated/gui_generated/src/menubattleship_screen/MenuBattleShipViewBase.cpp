...
MenuBattleShipViewBase::MenuBattleShipViewBase() :
    flexButtonCallback(this, &MenuBattleShipViewBase::flexButtonCallbackHandler)
{
...
void MenuBattleShipViewBase::setupScreen()
{

}

void MenuBattleShipViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &previousGame)
    {
        //leftGame
        //When previousGame clicked change screen to MenuMorpion
        //Go to MenuMorpion with screen transition towards West
        application().gotoMenuMorpionScreenSlideTransitionWest();
    }
}
