...
MorpionViewBase::MorpionViewBase() :
    flexButtonCallback(this, &MorpionViewBase::flexButtonCallbackHandler)
{
    ...
    win_p1.setXY(195, 121);
    win_p1.setVisible(false);
    add(win_p1);

    win_p2.setXY(195, 121);
...
void MorpionViewBase::setupScreen()
{
...
void MorpionViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &Restart)
    {
        //Restart_Game
    ...
    if (&src == &Quit)
    {
        ...
        Quit.invalidate();
        //QuitGame
        //When Quit clicked call quit_game on Morpion
        //Call quit_game
        quit_game();
    }
    if (&src == &Button_0_0)
...
void MorpionViewBase::transitionBegins()
{
    //Init
    //When screen transition begins call init on Morpion
    //Call init
    init();
}
